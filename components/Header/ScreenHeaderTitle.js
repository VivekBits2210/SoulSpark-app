...
const ScreenHeaderTitle = ({ handlePress, backgroundColor, src, imageHeight }) => {
  ...
  return (
    <TouchableOpacity
      ...
      onPress={handlePress}
    >
      <Image style={[styles.titleImage, {height: imageHeight, width: imageHeight*2}]} source={src}></Image>
    </TouchableOpacity>
  );
};
